          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>CCSIT Admin</span></li>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="time">
                     ...
                     <li class="ripple"><a href="userdatatables.php"><span class="fa fa-check-square-o"></span>User Details<span class="fa-angle-right fa right-arrow text-right"></span> </a>
                     
                    </li>
	<li class="ripple"><a href="companydatatables.php"><span class="fa fa-check-square-o"></span>Company Details<span class="fa-angle-right fa right-arrow text-right"></span> </a>
                     
                    </li>
                       <li class="ripple"><a href="approveduserdata.php"><span class="fa fa-check-square-o"></span>Approved Users<span class="fa-angle-right fa right-arrow text-right"></span> </a>
                     
                    </li>
                <li class="ripple"><a href="blockeduserdata.php"><span class="fa fa-check-square-o"></span>Blocked Users<span class="fa-angle-right fa right-arrow text-right"></span> </a>
                     
                    </li>
                <li class="ripple"><a href="approvedcompanydata.php"><span class="fa fa-check-square-o"></span>Approved Companies<span class="fa-angle-right fa right-arrow text-right"></span> </a>
                     
                    </li>
                <li class="ripple"><a href="blockedcompanydata.php"><span class="fa fa-check-square-o"></span>Blocked companies<span class="fa-angle-right fa right-arrow text-right"></span> </a>
          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>User Data Tables</h3></div>
                    <div class="panel-body">
...
$check="select status from userdetails";
$res=mysqli_query($con,$check) or die("query failed".mysqli_error($con));

$ret="select email,fname,lname,cno,gender,address,dob,pgcourse,pgmark,status from userdetails";
...
while($row = mysqli_fetch_array($q, MYSQL_ASSOC))
{
   ...
   echo"
                      ...
                      <tbody>
                        <tr>
                          <td>
<form method='POST' action='userpro.php'>";

$_SESSION['email']=$row['email'];
echo"
<a href='#'><input type='submit' value='{$row['email']}'></a>
</form>
</td>
                          <td>{$row['fname']}</td>
		<td>{$row['lname']}</td>
