...
<head>
 ...
 <!-- start:Left Menu -->
	...
	<li class="ripple"><a href="companydatatables.php"><span class="fa fa-check-square-o"></span>Company Details<span class="fa-angle-right fa right-arrow text-right"></span> </a>
                ...
                <li class="ripple"><a href="blockedcompanydata.php"><span class="fa fa-check-square-o"></span>Blocked compasnies<span class="fa-angle-right fa right-arrow text-right"></span> </a>
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span>Malappuram,Kerala</p>

                        <ul class="nav navbar-nav">
                            <li><a href="" >Calicut</a></li>
                            <li><a href="" class="active">Thrissur</a></li>
                            <li><a href="">Ernakulam</a></li>
                            <li><a href="">Thrivandrum</a></li>
                            <li><a href="">Kasargod</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="col-md-6 col-sm-6 text-right" style="padding-left:10px;">
                          <h3 style="color:#DDDDDE;"><span class="fa  fa-map-marker"></span>Kerala</h3>
                            ...
                            <div class="col-md-12 padding-0">
                                    ...
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                        <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                          <h4 class="text-left">Companies</h4>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                        <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                          <h4 class="text-left">Job Seekers</h4>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                                           <h4>
