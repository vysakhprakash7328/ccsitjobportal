...
<h1 align="center">Add Your New Advertisement...</h1>
<form method="post" action="advsubmit.php">
<table>
	<tr>
		<th>Post</th>
	...
	<tr>
		...
		<td><input type="date" name="intdate" required>
	</tr>
	<tr>
		<th>Interview Time:</th>
		<td><input type="time" name="inttime" required>
	</tr>
	<tr>
		<th>Interview Location:</th>
		<td><input type="text" name="intlocation" required>
	</tr>
</table>
