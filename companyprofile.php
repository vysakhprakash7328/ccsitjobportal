...
<?php
include("dbconnection.php");
$ret1="select bio from companydetails where email='$email'";
...
$ret="select companyemail,post,qualification,basicsalary,experience,interviewdate,interviewtime,interviewlocation from advertisement";
$q=mysqli_query($con,$ret) or die("query failed".mysqli_error($con));
while($row = mysqli_fetch_array($q, MYSQL_ASSOC))
{
   echo"
...
<a href="addadv.php" align="right"><button >Add</button></a>
