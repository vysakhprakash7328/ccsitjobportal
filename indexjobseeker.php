...
{
	header("location:jobseeker/jobseekerlogin.html");
}
...
<html lang="en-US">
    ...
    <body data-spy="scroll" data-target="#main-navbar">
    	...
    	<div class="body">
		 ...
		 <li><a class="page-scroll" href="jobseekerprofile.php">Profile</a></li>
                ...
                <div class="page-header-wrapper">
                    <div class="container">
                        <div class="page-header text-center wow fadeInDown" data-wow-delay="0.4s">
                            <h2>Advertisement</h2>
                            <div class="devider"></div>
                            <p class="subtitle">Top Companies</p>
                        </div>
                    </div>
                </div>
                <!-- End page header-->
...
$ret="select companyemail,post,qualification,basicsalary,experience,interviewdate,interviewtime,interviewlocation from advertisement ORDER BY id desc";
							...
							<div class="price-box col-sm-6 price-box-featured col-md-3 wow flipInY" data-wow-delay="0.7s">
								<div class="panel panel-default">
									...
									<div class="panel-body text-center">
										<p class="lead"><strong><?php echo"{$row['post']}"; ?></strong></p>
									</div>
									<ul class="list-group text-center">
										<li class="list-group-item">Qualification:<?php echo"{$row['qualification']}"; ?></li>
										<li class="list-group-item">Basic salary:Rs.<?php echo"{$row['basicsalary']}"; ?>/-</li>
										
									</ul>
									<div class="panel-footer text-center">
										<form method="POST" action="companyinfo/index.php">

										<?php $_SESSION['company']=$row['companyemail']; ?>
										<?php $_SESSION['post']=$row['post']; ?>
